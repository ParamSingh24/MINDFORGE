            ...
            <AnimatePresence>
                {isOpen && (
                    <motion.div
                        ...
                        className="fixed bottom-20 right-4 sm:right-6 w-[calc(100vw-2rem)] sm:w-[350px] h-[60vh] min-h-[400px] max-h-[500px] bg-black/80 backdrop-blur-xl border border-white/10 rounded-2xl shadow-2xl z-50 flex flex-col overflow-hidden"
                    >
                        {/* Header */}
