  ...
  return (
    <section id="about" className="py-24 px-6 relative overflow-hidden">
      ...
      <div className="container mx-auto max-w-6xl">
        ...
        >
          <div className="grid grid-cols-3 gap-4 md:gap-8 mb-8 border-b border-white/10 pb-6 text-sm md:text-lg font-bold text-white">
          ...
          <div className="space-y-6">
            {comparisonData.map((row, index) => (
              <motion.div
                ...
                className="grid grid-cols-3 gap-4 md:gap-8 items-center text-sm md:text-base"
              >
                <div className="font-medium text-gray-300">{row.feature}</div>
                <div className="flex items-center text-gray-400">
                  <XCircle className="w-4 h-4 md:w-5 md:h-5 text-red-500 mr-2 flex-shrink-0" />
                  <span>{row.freelancer}</span>
                </div>
                <div className="flex items-center text-white font-semibold">
                  <CheckCircle2 className="w-4 h-4 md:w-5 md:h-5 text-mindforge-green mr-2 flex-shrink-0" />
